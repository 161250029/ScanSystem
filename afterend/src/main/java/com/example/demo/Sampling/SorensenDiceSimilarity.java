...
public class SorensenDiceSimilarity implements SimilarityAlgorithm {
...
//    private static final Pattern FEATURE_PATTERN = Pattern.compile("[a-zA-Z0-9$_]+");
    ...
    private double getSorensenDice(final String a, final String b){
