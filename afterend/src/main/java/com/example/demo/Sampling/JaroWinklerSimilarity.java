...
public class JaroWinklerSimilarity implements SimilarityAlgorithm {
     ...
     * @param threshold
     */
    public JaroWinklerSimilarity(final double threshold) {
     ...
     */
    public final double getJaro(final String s1, final String s2) {
        if (s1 == null) {
